  ...
  const handleEnhance = async () => {
    ...
    for (let i = 0; i < images.length; i++) {
      ...
      try {
        ...
        const prompt = `Enhance this real estate photograph into a cinematic, ultra high-resolution frame. Keep the original composition, subject position, and framing exactly the same. Improve quality and realism only — do not change objects or structure. Clean up any overlaid text or UI elements that are not part of the actual scene. Increase sharpness, clarity, and dynamic range. Make lighting look professionally captured on ARRI Alexa 35 with cinematic color grading, soft highlight roll-off, rich shadows, realistic contrast, and true-to-life colors. Add subtle depth, refined texture detail, and natural light falloff. Output as a 16:9 cinematic frame. Ultra-detailed, 8K resolution, professional HDR balance, premium production quality.`;
